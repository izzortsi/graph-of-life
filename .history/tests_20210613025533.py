...
# %%
g_vixs1 = g.get_vertices()
print(g.num_vertices())
g.remove_vertex([0,1], fast = True)
print(g.num_vertices())
g_vixs2 = g.get_vertices()
...
def run_simulation():
    ...
    #print(vertices)
    diff = len(vertices) - len(states)
    if diff >= 1:
        print(diff) #this eventually results in something ≠ 0, I still haven't find out why 
    ###
