    ...
    for i in range(1, n_iter + 1):
        ...
        if draw == True:
            ...
            gt.graph_draw(
                ...
                vertex_size=9,
                output_size=(plt_scale * n, plt_scale * m),
                output=fname_prefix + "_draw%04d.png" % (i + 1),
            )
        Gs.append(G)
...
def display_interactive_ga(ga_seq):
    ...
    gt.interactive_window(
        ga_seq[0],
        pos=ga_seq[0].vp.pos,
        vertex_fill_color=ga_seq[0].vp.color,
        update_layout=True,
        main=False,
        return_window=False,
    )
    ...
    def _show(gidx=(0, len(ga_seq) - 1)):
        return gt.interactive_window(
            ga_seq[gidx],
            pos=ga_seq[gidx].vp.pos,
            vertex_fill_color=ga_seq[gidx].vp.color,
            update_layout=True,
            main=False,
            window=gtwin,
            return_window=False,
